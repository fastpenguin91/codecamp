...
function allPoss(str){
  ...
  for (let i = 0; i < str.length; i++ ) {
    ...
    for (let i2 = 0; i2 < strList.length; i2++) {
      ...
      let testStr = strList[i2].slice(0, i) + str[i + tmpInc];

///////////////// insert or dont

        if (timesExisted >= timesToExist){
//          console.log("cant add anymore of the string: " + testStr);
          tmpInc++;
          timesExisted = 0;
        //  testStr = ""; // maybe not necessary
        } else {
      ...
      ///////////////// insert or dont ///////////////// insert or dont

      // Replace the old string with the new string
//      strList.splice(i2,1, testStr);

      console.log("tmpInc: " + tmpInc);
      console.log(strList);
    }

//    console.log("times Existed: " + timesExisted);
//    console.log("strLength: " + strLength);
//    console.log("possibilities: " + numOfPossibilities);
//    console.log("times to exist: " + timesToExist);
