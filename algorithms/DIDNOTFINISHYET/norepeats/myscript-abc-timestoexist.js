...
//      console.log("strLength: " + strLength + " Possib: " + numOfPossibilities + " ");
//      console.log("working on index: " + i + " of: " + (str.length - 1) + " timesToExist: " + timesToExist );
      let testStr = strList[i2].slice(0, i) + str[i];



      if (strList.includes(testStr) ) {
      } else {
